...
namespace Tool.Doc
{
    public class PdfTool
    {
        ...
        /// 合併PDF
        /// </summary>
        public byte[] MergePDFFiles(List<byte[]> pdfByteContent)
        {
        ...
        /// 分割PDF文件
        /// </summary>
        public byte[] SplitPDFFiles(byte[] pdfByteContent, int startPage, int endPage)
        {
            try
            {
                ...
                return MergePDFFiles(pdfByteList);
            }
            catch (Exception ex)
            {
                throw ex;
